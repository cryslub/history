...
<!--   <script type="text/javascript" src="js/three.min.js"></script> -->
  ...
  <script type="text/javascript" src="js/globe-mobile.js"></script>
	...
	<div ng-app="myApp" class="wrapper" ng-controller="myCtrl"
		...
		<div id="container"></div>
		  <div id="currentInfo">
			...
			<button data-toggle="modal" class="btn btn-outline-light btn-sm" data-target="#scenario">Scenario</button>
